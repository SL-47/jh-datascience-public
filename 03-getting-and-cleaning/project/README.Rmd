...
### Use
Once the data is in the structure above set the working directory to the root of the directory structure show. Execute the `run_analysis.R` script. The tidy data set will be place in a file `analysis.csv`.
